...
if __name__ == '__main__':
    model = YOLO('ultralytics/cfg/models/11/yolov11.yaml')  # 指定YOLO模型对象，并加载指定配置文件中的模型配置
    # model.load('yolov11s.pt')      #加载预训练的权重文件'yolov11s.pt'，加速训练并提升模型性能
    model.train(data='ultralytics/cfg/datasets/NEU-DET.yaml',
